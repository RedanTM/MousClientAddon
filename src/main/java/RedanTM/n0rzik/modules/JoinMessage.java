...
public class JoinMessage extends MousModule {
    ...
    public JoinMessage() {
        super(Mous.CATEGORY, "join-message", "Runs command when you spawn in a server. Put (me) to put username automatically.");
    }
