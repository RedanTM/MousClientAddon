/*
Modified from https://github.com/AntiCope/meteor-rejects/blob/master/src/main/java/anticope/rejects/utils/gui/RoundedRenderer2D.java
 */

package RedanTM.n0rzik.util;
