package RedanTM.n0rzik.util.Surround;
...
public class Automation {
    ...
    public static boolean isBurrowed(PlayerEntity p, boolean holeCheck) {
        ...
        if (holeCheck && !HelperSurround.isInHole(p)) return false;
    ...
    public static void mineWeb(PlayerEntity p, int swordSlot) {
        ...
        HelperSurround.updateSlot(swordSlot);
    ...
    public static void doPacketMine(BlockPos targetPos) {
        ...
        HelperSurround.swingHand(false);
    ...
    public static void doRegularMine(BlockPos targetPos) {
        ...
        Rotations.rotate(Rotations.getYaw(hitPos), Rotations.getPitch(hitPos), 50, () -> HelperSurround.swingHand(false));
    }
}