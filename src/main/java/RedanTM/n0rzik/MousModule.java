...
import RedanTM.n0rzik.util.Module.PriorityUtils;
...
public class MousModule extends Module {
    private final String prefix = Formatting.DARK_GRAY + "[MousClient]";
    public int priority;

    public MousModule(Category category, String name, String description) {
